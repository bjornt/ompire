...
drafting, waiting for your publication decision, publishing, merge waiting, or
cleanup. The card never starts a review or privileged publication itself, and
neither does opening the task-specific Ship flow; see
[Ship flow](ship-flow.md#2-publication-text).
