...
This page covers those layered scalar settings. The other thing edited from the
same Settings view is a registry entity with its own lifecycle rather than a
setting — [model profiles](model-profiles.md) — and is documented on its own
page.
